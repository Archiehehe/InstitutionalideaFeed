              ...
              {instLists
                ...
                .map((l) => (
                  <div
                    ...
                    className="text-xs text-[#E5E7EB] flex flex-wrap items-center justify-between gap-2"
                  >
                    <Link
...
function OverlapPageBody({
  ...
  handleSelectChange: (key: string, value: string | null) => void;
}) {
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Find stocks repeatedly appearing across sell-side lists. Repeated
            mentions are not recommendations by themselves; use this as a
          ...
          <div className="absolute right-0 top-0 h-full w-full max-w-3xl overflow-y-auto bg-[#0A0A0A] border-l border-[#1F1F1F]">
            <div className="p-4 sm:p-6">
              ...
              <div className="mt-4 grid grid-cols-2 gap-3">
                <Stat
                  label="Mention count"
                  value={String(selectedRow.mentionCount)}
                />
                <Stat
                  label="Institution count"
                  value={String(selectedRow.institutionCount)}
                />
                <Stat
                  label="Latest"
              ...
              <div className="mt-5 rounded-md border border-[#1F1F1F] bg-[#0A0A0A] p-4">
                <div className="flex flex-wrap items-center justify-between gap-2">
                  <div className="flex items-center gap-2 text-xs text-muted-foreground">
                    <Eye className="h-3.5 w-3.5" /> Research drawer (not
                    investment advice)
                  </div>
                  <div className="flex flex-wrap gap-2">
                    ...
                    <Button
                      ...
                      size="sm"
                      className="gap-1"
                      onClick={() => copyTicker(selectedRow.ticker)}
                    >
              ...
              <div className="mt-5 space-y-5">
                ...
                <SignalSummary row={selectedRow} />

                <div className="flex flex-wrap items-center justify-between gap-3 pt-3">
                  <div className="text-xs text-muted-foreground">
                    Most common themes/sectors are derived from list metadata in
                  ...
                  <div className="flex flex-wrap gap-2">
                    <Button
                      ...
                      onClick={() =>
                        router.push(
                          `/conviction-lists?search=${selectedRow.ticker}`,
                        )
                      }
                    >
